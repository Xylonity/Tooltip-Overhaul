...
public class LinearDividerLine implements DividerLineLayer {
    ...
    public void render(TooltipContext context, Vec2 position) {
        ...
        buf.vertex(matrix, context.getTooltipPosition().x - paddingX, y + 1, 0).color(r, g, b, 255).endVertex();
        buf.vertex(matrix, centerX, y + 1, 0).color(r, g, b, 255).endVertex();
        buf.vertex(matrix, centerX, y, 0).color(r, g, b, 255).endVertex();
        buf.vertex(matrix, context.getTooltipPosition().x - paddingX, y, 0).color(r, g, b, 255).endVertex();
