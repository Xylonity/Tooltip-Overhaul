...
public class TextUtils {
    ...
    public static List<ClientTooltipComponent> getTooltipComponentsFrom(ItemStack stack, Font font, int screenWidth, float screenSplit) {
        ...
        assert player != null;
        List<Component> originalComponentLines = stack.getTooltipLines(Item.TooltipContext.of(player.level()), player, minecraft.options.advancedItemTooltips ? TooltipFlag.ADVANCED : TooltipFlag.NORMAL);
