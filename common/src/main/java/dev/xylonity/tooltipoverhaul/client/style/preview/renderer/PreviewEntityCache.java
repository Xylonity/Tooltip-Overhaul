...
public final class PreviewEntityCache {
    ...
    private static final PlayerSkin SKIN = new PlayerSkin(TooltipOverhaul.pathOf("textures/preview/dummy.png"), null, null, null, PlayerSkin.Model.WIDE, true);
    ...
    private static final class PreviewPlayer extends RemotePlayer {
        ...
        public PlayerSkin getSkin() {
            ...
            return usePlayerSkin && local != null ? local.getSkin() : SKIN;
        }
