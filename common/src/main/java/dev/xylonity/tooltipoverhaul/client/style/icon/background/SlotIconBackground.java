...
public class SlotIconBackground implements IconBackgroundLayer {
    ...
    public void render(TooltipContext context, Vec2 position) {
        ...
        // Top border
        context.getGraphics().fill(x0, y0 - 1, x1, y0, ColorUtils.getIconBackgroundColor(context, 0x903E3E3E));
        // Bottom border
        context.getGraphics().fill(x0, y1 + 1, x1, y1, ColorUtils.getIconBackgroundColor(context, 0x903E3E3E));
        // Left border
        context.getGraphics().fill(x0 - 1, y0, x0, y1, ColorUtils.getIconBackgroundColor(context, 0x903E3E3E));
        // Right border
        context.getGraphics().fill(x1 + 1, y0, x1, y1, ColorUtils.getIconBackgroundColor(context, 0x903E3E3E));
    }
