...
public final class GradientOrnamentDividerLine implements DividerLineLayer {
    ...
    public void render(TooltipContext context, Vec2 position) {
        ...
        // Left
        buffer.vertex(matrix, left, y + 1, 0).color(red, green, blue, 0).endVertex();
        buffer.vertex(matrix, center - 3, y + 1, 0).color(red, green, blue, alpha).endVertex();
        buffer.vertex(matrix, center - 3, y, 0).color(red, green, blue, alpha).endVertex();
        buffer.vertex(matrix, left, y, 0).color(red, green, blue, 0).endVertex();

        // Right
        buffer.vertex(matrix, center + 4, y + 1, 0).color(red, green, blue, alpha).endVertex();
        buffer.vertex(matrix, right, y + 1, 0).color(red, green, blue, 0).endVertex();
        buffer.vertex(matrix, right, y, 0).color(red, green, blue, 0).endVertex();
        buffer.vertex(matrix, center + 4, y, 0).color(red, green, blue, alpha).endVertex();
