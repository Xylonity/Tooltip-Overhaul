...
public class TooltipContext {
    ...
    public TooltipContext(GuiGraphics graphics, int mouseX, int mouseY, int screenW, int screenH, List<ClientTooltipComponent> components, ItemStack stack, @Nullable TooltipContext otherTooltipContext, boolean isMainTooltip) {
