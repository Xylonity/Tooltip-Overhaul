...
public class DefaultBackground implements BackgroundLayer {
    ...
    public void render(TooltipContext context, Vec2 position) {
        ...
        // Top border
        context.getGraphics().fill(x0, y0 - 1, x1, y0, backgroundColor);
        // Bottom border
        context.getGraphics().fill(x0, y1 + 1, x1, y1, backgroundColor);
        // Left border
        context.getGraphics().fill(x0 - 1, y0, x0, y1, backgroundColor);
        // Right border
