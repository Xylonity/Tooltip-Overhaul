...
public class TooltipOverhaulConfigScreen extends Screen {
    ...
    private void renderFooterSeparator(GuiGraphics graphics) {
        ...
        // Left
        buffer.addVertex(matrix, x0, y + h, 0).setColor(red, green, blue, 0);
        buffer.addVertex(matrix, centerX, y + h, 0).setColor(red, green, blue, 255);
        buffer.addVertex(matrix, centerX, y, 0).setColor(red, green, blue, 255);
        buffer.addVertex(matrix, x0, y, 0).setColor(red, green, blue, 0);

        // RighaddVertex()
        buffer.addVertex(matrix, centerX, y + h, 0).setColor(red, green, blue, 255);
        buffer.addVertex(matrix, x1, y + h, 0).setColor(red, green, blue, 0);
        buffer.addVertex(matrix, x1, y, 0).setColor(red, green, blue, 0);
        buffer.addVertex(matrix, centerX, y, 0).setColor(red, green, blue, 255);
    ...
    private void renderSearchBackground(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        if (searchHoverProgress > 0f) {
            ...
            bufferBuilder.addVertex(matrix, x0, y1, 0).setColor(0x4A, 0x9E, 0xFF, maxA);
            bufferBuilder.addVertex(matrix, x1, y1, 0).setColor(0x4A, 0x9E, 0xFF, 0);
            bufferBuilder.addVertex(matrix, x1, y0, 0).setColor(0x4A, 0x9E, 0xFF, 0);
            bufferBuilder.addVertex(matrix, x0, y0, 0).setColor(0x4A, 0x9E, 0xFF, maxA);
    ...
    static class ConfigPanel extends AbstractWidget {
        ...
        @Override
        public boolean mouseScrolled(double mouseX, double mouseY, double horizontalAmount, double verticalAmount) {            if (!this.visible) {
            return false;
        }
